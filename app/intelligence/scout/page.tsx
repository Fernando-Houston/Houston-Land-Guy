    ...
    const mockOpportunities: Opportunity[] = [
      {
        id: '001',
        type: 'land_assembly',
        title: 'Prime Assembly Opportunity - Spring Branch Growth Corridor',
        location: 'Spring Branch',
        address: '1400-1420 Long Point Rd',
        price: 2850000,
        size: '0.68 acres',
        ...
        highlights: [
          'Spring Branch showing 18.3% YoY appreciation',
          'Three contiguous parcels available',
          'Near major employment centers',
          'Strong rental demand area'
        ],
        aiInsight: 'Fernando-X detected exceptional opportunity in Spring Branch - Houston\'s highest ROI neighborhood at 18.3% YoY. Area transformation accelerating with new developments.',
        coordinates: { lat: 29.7825, lng: -95.4619 },
        status: 'hot',
        riskLevel: 'low',
        estimatedROI: '18-25%',
        marketComps: 3,
        distressSignals: ['Motivated seller', 'Below market pricing']
      },
      {
        id: '002',
        type: 'price_drop',
        title: 'Cypress Development Site - Hot Market Opportunity',
        location: 'Cypress (77433)',
        address: '15800 Spring Cypress Rd',
        price: 1850000,
        previousPrice: 2200000,
        priceChange: -16,
        size: '2.5 acres',
        zoning: 'Commercial/Residential',
        potential: '80-unit apartments or 45 townhomes',
        score: 98,
